...
function refreshMasterInventoryListDOMUI() {
    ...
    dynamicStoredItemsMemoryDatabase.forEach((productStringName, lookupIndex) => {
        ...
        generatedListItemsHtmlStructure += `
            ...
            <li style="margin-bottom:4px; color:#2d3748; font-weight:500;">

                ${productStringName}

                <span onclick="deleteProductFromInventoryRegistry(${lookupIndex})" style="color:#e53e3e; font-size:0.75rem; cursor:pointer; font-weight:normal; margin-left:10px; text-decoration:underline;">[ Delete permanently ]</span>
    ...
    if(listHtmlOutputDisplayTargetElement) {
        ...
        listHtmlOutputDisplayTargetElement.innerHTML = generatedListItemsHtmlStructure || `<span style="color:#a0aec0; font-style:italic;">No custom items saved inside registry repository storage log!</span>`;
...
allCurrentRowsNodeList.forEach((rowNode) => {
    ...
    tableRowsMarkup += `
        <tr style="height: 28px;">
            ...
            <td style="border-right: 1px solid #000000; padding: 5px; text-align: right;">${unitRate.toFixed(2)}</td>
            <td style="padding: 5px; text-align: right;">${calculatedLineAmount.toFixed(2)}</td>` : ''}
        </tr>
    `;
});
...
if (currentRows < totalRows) {
    ...
    if (extractionTargetDocumentSelectionType === "INVOICE") {
        summarySectionHtml = `
            <div style="width: 100%; border-left: 1px solid #000000; border-right: 1px solid #000000; border-bottom: 1px solid #000000; box-sizing: border-box; display: flex; margin-top: -1px;">
                <div style="width: 58%; padding: 10px; border-right: 1px solid #000000; font-size: 13px; font-weight: bold; text-transform: uppercase; display: flex; align-items: center; word-break: break-all;">
                ...
                <div style="width: 42%;">
                    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                        <tr>
                            <td style="border-right: 1px solid #000000; border-bottom: 1px solid #000000; padding: 5px; text-align: right; font-weight: bold; width: 60%;">TOTAL AMOUNT:</td>
                            <td style="border-bottom: 1px solid #000000; padding: 5px; text-align: right; width: 40%;">${totalAccumulatedFinancialSum.toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td style="border-right: 1px solid #000000; border-bottom: 1px solid #000000; padding: 5px; text-align: right; font-weight: bold;">NET PAYABLE:</td>
                            <td style="border-bottom: 1px solid #000000; padding: 5px; text-align: right;">${totalAccumulatedFinancialSum.toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td style="border-right: 1px solid #000000; border-bottom: 1px solid #000000; padding: 5px; text-align: right; font-weight: bold;">PAID AMOUNT:</td>
                            <td style="border-bottom: 1px solid #000000; padding: 5px; text-align: right;">${paidAmount.toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td style="border-right: 1px solid #000000; padding: 5px; text-align: right; font-weight: bold;">BILL DUE:</td>
                            <td style="padding: 5px; text-align: right;">${netBillDue.toFixed(2)}</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    if (extractionTargetDocumentSelectionType === "CHALLAN") {
        ...
        headerTitleText = "INVOICE DETAILS (DUE)";
    ...
    const previewDocumentContent = `
        ...
        <body>
            ...
            <div id="print_area">
                ...
                <table style="width: 100%; border-collapse: collapse; margin: 0; font-size: 12px; color: #000000; border: 1px solid #000000; box-sizing: border-box;">
                    ...
                    <thead>
                        ...
                        <tr style="text-align: center; font-weight: bold; background-color: #ffffff; height: 30px;">
                            ...
                            <th style="border-right: 1px solid #000000; border-bottom: 1px solid #000000; width: 8%;">S.N.</th>

                            <th style="border-right: 1px solid #000000; border-bottom: 1px solid #000000; width: 50%;">ITEM NAME</th>
                            ...
                            <th style="border-right: 1px solid #000000; border-bottom: 1px solid #000000; width: 10%;">RATE (TK)</th>

                            <th style="border-bottom: 1px solid #000000; width: 10%;">AMOUNT (TK)</th>` : ''}
                ...
                <div style="margin-top: 70px; display: flex; justify-content: space-between; font-size: 11px; font-weight: bold; text-transform: uppercase; color: #000000; padding: 0 5px;">
